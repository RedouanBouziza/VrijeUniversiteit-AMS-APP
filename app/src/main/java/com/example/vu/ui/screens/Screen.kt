...
sealed class Screen(
    ...
    object BreathingSettings: Screen("breathingSettings", R.string.breathingSettings, Icons.Default.MonitorHeart)
    object BreathingExercise: Screen("BreathingExercise", R.string.breathingSettings, Icons.Default.MonitorHeart)
